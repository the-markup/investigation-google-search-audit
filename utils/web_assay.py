...
Web Assay
=========
Contains the WebAssay base class and GoogleWebAssay class.

These functions are used to create web drivers, identify different kinds
of elements on a web page, calculate area (real estate), and stain rendered pages.
                ...
                for child in all_children_by_xpath:
                    if child.is_displayed():
                        ...
                        if style:
                            ...
                            style = custom_style
                        self.driver.execute_script(
                            f"arguments[0].setAttribute('style','{style}')", child
                        )        
        return True
